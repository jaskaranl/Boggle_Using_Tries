...
int main(){
    ...
    TrieNode *temp=NULL;
    ifstream dictionary;
    dictionary.open("/Users/aryan/Desktop/boggle/boggle/english3.txt");  // opening file containing all words,letters
    ...
    cout<<"\n\n";
    cout<<"Project made by Aryan Mehta 2K20/IT/32 and Jaskaran Kamboj 2K20/IT/65\n"<<endl;
    delete temp;
    return 0;
}
